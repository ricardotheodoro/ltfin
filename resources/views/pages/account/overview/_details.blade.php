    ...
    <div class="card-body p-9">
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8 fv-row">
                <span class="fw-bold fs-6">{{ $accountInfo->company ?? '-' }}</span>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8 d-flex align-items-center">
                <span class="fw-bolder fs-6 me-2">{{ $accountInfo->phone ?? '-' }}</span>
        ...
        <div class="row mb-7">
            ...
            <!--begin::Col-->
            <div class="col-lg-8">
                @if(!empty($accountInfo->website))
                    <a href="{{ $accountInfo->website }}" target="_blank" rel="noopener noreferrer" class="fw-bold fs-6 text-dark text-hover-primary">{{ $accountInfo->website }}</a>
                @else
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8">
                <span class="fw-bolder fs-6 text-dark">
                    {{ data_get(\App\Core\Data::getCountriesList(), ($accountInfo->country ?? '') . '.name', '-') }}
                </span>
            </div>
            <!--end::Col-->
        </div>
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8">
                <span class="fw-bolder fs-6 text-dark">
                    {{ implode(', ', array_map('ucwords', array_keys(array_filter($accountInfo->communication ?? [])))) ?: '-' }}
                </span>
            </div>
            <!--end::Col-->
        </div>
